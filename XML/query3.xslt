...
<xsl:key name="companies" match="company" use="companyID" />

<xsl:template match="/">
  <xsl:text>What headphones were made by Sony?&#10;</xsl:text>
  <xsl:apply-templates select="//headphone[key('companies', companyID)/companyName='Sony']"/>
</xsl:template>
